...
const AudioEngine = (() => {
  ...
  // Load and cache the pt-BR voice
  function loadVoice() {
    if (typeof window === 'undefined' || !window.speechSynthesis) return;
    const voices = window.speechSynthesis.getVoices();
    // Try to find pt-BR voice
    portugueseVoice = voices.find(v => v.lang.toLowerCase() === 'pt-br' || v.lang.toLowerCase().replace('_', '-') === 'pt-br') ||
  ...
  // Pronounce words/sentences using pt-BR voice
  function speak(text) {
    if (typeof window === 'undefined' || !window.speechSynthesis) {
